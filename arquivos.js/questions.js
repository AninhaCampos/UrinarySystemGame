const questions = [
    ...
    },
    {
        ...
        options: ["Aumentando o volume de sangue circulante.","Reduzindo o calibre dos vasos sanguíneos.","Dilatando o calibre dos vasos sanguíneos.","Obstruindo os capilares arteriais com placas de ateroma."],
    ...
    },
    {
        ...
        options: ["cloreto de sódio.","glicídios.","lipídios.","proteínas."],
    ...
    },
    {
        ...
        options: ["cápsula de Bowman. ","ureter.","glomérulo de Malpighi.","túbulo contornado proximal."],
        optionCorreta: "túbulo contornado proximal.",
    },
    {
        question: 'UFRR 2016 - As trocas metabólicas ocorrem por meio de diversos órgãos, incluindo a pele, fígado, as brânquias, os pulmões, os rins e estruturas especiais que eliminam ou absorvem sal. Os resíduos nitrogenados gerados pelo corpo são produzidos principalmente no fígado e são eliminados pelo organismo. Em relação aos resíduos nitrogenados, assinale a alternativa correta:',
        options: ["A maior parte dos resíduos nitrogenados dos peixes de água doce são excretados como ureia","A maior parte dos resíduos nitrogenados dos mamíferos são excretados na forma de ureia","A maior parte dos resíduos nitrogenados dos tubarões são excretados na forma de ácido úrico","A maior parte dos resíduos nitrogenados dos répteis são excretados na forma de amônia"],
        optionCorreta: "a maior parte dos resíduos nitrogenados dos mamíferos são excretados na forma de ureia",
    },
];